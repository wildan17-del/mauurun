  ...
  <div class="container">
    <div class="register-hero" @if($event->gambar) style="background-image: url('{{ asset('storage/'.$event->gambar) }}');" @endif>
      ...
      <div class="register-hero__content">
        <a href="{{ route('peserta.events.index') }}" class="register-hero__back">
        ...
        <h1 class="register-hero__title">{{ $event->nama_event }}</h1>
    ...
    <div class="register-body">
      ...
      <div class="register-card">
        ...
        <form method="POST" action="{{ route('peserta.events.daftar.store', $event) }}" class="register-form">
          @csrf
            ...
            <div class="register-form__row">
              <div class="register-form__group">
                ...
                <div class="register-form__input-wrap">
                  ...
                  <input type="tel" id="no_hp" name="no_hp" value="{{ old('no_hp') }}" placeholder="Contoh: 085388290" required>
                </div>
              ...
              <div class="register-form__group">
                ...
                <div class="register-form__radio-group">
                  <label class="register-form__radio-label {{ old('jenis_kelamin') === 'Laki-Laki' ? 'is-selected' : '' }}">
                  ...
                  <label class="register-form__radio-label {{ old('jenis_kelamin') === 'Perempuan' ? 'is-selected' : '' }}">
            ...
            <div class="register-form__row">
              <div class="register-form__group">
                ...
                <div class="register-form__size-picker">
                  @foreach(['S','M','L','XL','XXL'] as $ukuran)
                    <label class="register-form__size-option {{ old('ukuran_jersey') === $ukuran ? 'is-active' : '' }}">
                      <input type="radio" name="ukuran_jersey" value="{{ $ukuran }}" {{ old('ukuran_jersey') === $ukuran ? 'checked' : '' }} required>
              ...
              <div class="register-form__group">
                ...
                <div class="register-form__input-wrap">
                  ...
                  <input type="text" id="kode_kupon" name="kode_kupon" value="{{ old('kode_kupon') }}" placeholder="Masukkan kode kupon">
                </div>
          ...
          <div class="register-form__actions">
            ...
            <a href="{{ route('peserta.events.index') }}" class="register-form__btn register-form__btn--outline">Batal</a>
          </div>
        </form>
      </div>
    </div>
